...
Fusion techniques have previously shown their efficiency, mainly on tex and image related tasks, where there is a need to model the relation  between images and text extracts.
%
%. 
%
